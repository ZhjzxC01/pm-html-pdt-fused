...
node scripts/brand/validate-asset.cjs <path>
```

**Tokens:**
```bash
node scripts/design-system/generate-tokens.cjs -c tokens.json
node scripts/design-system/validate-tokens.cjs -d src/
```
